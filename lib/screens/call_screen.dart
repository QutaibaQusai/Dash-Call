          ...
          Padding(
            ...
            child: StreamBuilder(
              ...
              builder: (context, snapshot) {
                final duration = DateTime.now().difference(widget.sipService.callStartTime!);
                return Text(
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              // Mute button
              _buildControlButton(
                icon: widget.sipService.isMuted ? CupertinoIcons.mic_slash_fill : CupertinoIcons.mic_fill,
                label: 'mute',
